...
class MsJcjfData:
    ...
    def get_pre_age_info(self):
        ...
        for i in JCJF.objects(Q(案由='继承纠纷')):
            if i.头部信息:
    ...
    def get_court_info(self):
        ...
        court1 =[('万州区人民法院', 30), ('丰都县人民法院', 28), ('九龙坡区人民法院', 115), ('云阳县人民法院', 13), ('北碚区人民法院', 49), ('南岸区人民法院', 43), ('南川区人民法院', 21), ('合川区人民法院', 69), ('垫江县人民法院', 5), ('城口县人民法院', 3), ('大渡口区人民法院', 25), ('大足区人民法院', 13), ('奉节县人民法院', 12), ('巫山县人民法院', 7), ('巫溪县人民法院', 10), ('巴南区人民法院', 52), ('开州区人民法院', 12), ('彭水苗族土家族自治县人民法院', 15), ('忠县人民法院', 15), ('梁平区人民法院', 88), ('武隆区人民法院', 1), ('永川区人民法院', 4), ('江北区人民法院', 36), ('江津区人民法院', 56), ('沙坪坝区人民法院', 88), ('涪陵区人民法院', 22), ('渝中区人民法院', 44), ('渝北区人民法院', 52), ('潼南区人民法院', 4), ('璧山区人民法院', 15), ('石柱土家族自治县人民法院', 5), ('秀山土家族苗族自治县人民法院', 13), ('第一中级人民法院', 14), ('第三中级人民法院', 12), ('第二中级人民法院', 9), ('第五中级人民法院', 32), ('第四中级人民法院', 5), ('綦江区人民法院', 35), ('荣昌区人民法院', 11), ('铜梁区人民法院', 4), ('长寿区人民法院', 25), ('高级人民法院', 11), ('黔江区人民法院', 4)]
        court = {}
        for i in court1:
            m = i[0].replace('区','')
            m = m.replace('人民法院', '')
    ...
    def get_map_data(self):
        MAP = []
        court = MsJcjfData().get_court_info()
    ...
    def get_chart_age_data(self, age_info):
        chart_age_data = {}
        chart_age_data['PLAAGE'] = MsJcjfData().age_dict_get(age_info[1])#'原告年龄分布'
        chart_age_data['DEFAGE'] = MsJcjfData().age_dict_get(age_info[2])#'原告女性年龄分布'
        chart_age_data['PLAAGE_MALE'] = MsJcjfData().age_dict_get(age_info[3])#'原告男性年龄分布'
        chart_age_data['PLAAGE_FEMALE'] = MsJcjfData().age_dict_get(age_info[4])#'被告年龄分布'
        chart_age_data['DEFAGE_MALE'] = MsJcjfData().age_dict_get(age_info[5])#'被告男性年龄分布'
        chart_age_data['DEFAGE_FEMALE'] = MsJcjfData().age_dict_get(age_info[6])#'被告女性年龄分布'
...
# d,f=MsJcjfData().get_defendant_edujob()
# JCEDU=MsJcjfData().get_case_edu_number(d)
# job=list(f.keys())
# job_number=list(f.values())
# job_all=[job,job_number]
# print(job_all)
# print(JCEDU)
# print(JCJF.objects(Q(案由='继承纠纷')).count())
# court = MsJcjfData().get_court_info()#'各地区案件数量'
# age_info = MsJcjfData().get_pre_age_info()#获得未处的年龄数据
# chart_age_data = MsJcjfData().get_chart_age_data(age_info)#对未处理的年龄数据进行处理
# case_date_number = MsJcjfData().get_case_date_number()
...
PLAAGE = {'20岁以下': 13, '20~30岁': 69, '31~40岁': 92, '41~50岁': 191, '51~60岁': 211, '61~70岁': 223, '70岁以上': 193}
PLAAGE_FEMALE = {'20岁以下': 10, '20~30岁': 53, '31~40岁': 101, '41~50岁': 221, '51~60岁': 193, '61~70岁': 259, '70岁以上': 152}
PLAAGE_MALE = {'20岁以下': 4, '20~30岁': 39, '31~40岁': 46, '41~50岁': 101, '51~60岁': 103, '61~70岁': 104, '70岁以上': 77}
DEFAGE = {'20岁以下': 2, '20~30岁': 18, '31~40岁': 42, '41~50岁': 71, '51~60岁': 87, '61~70岁': 86, '70岁以上': 59}
DEFAGE_MALE = {'20岁以下': 4, '20~30岁': 24, '31~40岁': 40, '41~50岁': 111, '51~60岁': 90, '61~70岁': 141, '70岁以上': 63}
DEFAGE_FEMALE = {'20岁以下': 5, '20~30岁': 29, '31~40岁': 61, '41~50岁': 109, '51~60岁': 102, '61~70岁': 118, '70岁以上': 89}
plaintiff_sex = {'男': 914, '女': 947}
defendant_sex = {'男': 499, '女': 556}
aj_male = [plaintiff_sex['男'],defendant_sex['男']]
aj_female = [plaintiff_sex['女'],defendant_sex['女']]
case_date_number = {'2017': 314, '2018': 799, '2019': 1125}
bubble_data = MsJcjfData().get_bubble_data(PLAAGE, DEFAGE)
...
class OverviewInfo:
    ...
    def get_line_data(self, data):
        ...
        line_data = [date_list, date_number, '继承纠纷案件']
        return line_data

    def get_overview_data(self):
        map_jdjf_data = MsJcjfData().get_map_data()
        jdjf_ajnumber = 2423#LHJF.objects.count()  #
...
overview_data_jcjf = OverviewInfo().get_overview_data()
...
class ChartData:
    ...
    def get_person_info(self):
        ...
        return person_info
person_info_jcjf = ChartData().get_person_info()