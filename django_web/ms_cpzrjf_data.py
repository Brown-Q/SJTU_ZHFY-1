...
class MsCpjfData:
    ...
    def get_court_info(self):
        ...
        court1 =[ ('万州区人民法院', 51), ('丰都县人民法院', 5), ('九龙坡区人民法院', 752), ('云阳县人民法院', 13), ('北碚区人民法院', 371), ('南岸区人民法院', 592), ('南川区人民法院', 12), ('合川区人民法院', 223), ('垫江县人民法院', 3), ('大渡口区人民法院', 174), ('大足区人民法院', 9), ('奉节县人民法院', 7), ('巫山县人民法院', 8), ('巫溪县人民法院', 2), ('巴南区人民法院', 286), ('开州区人民法院', 4), ('彭水苗族土家族自治县人民法院', 2), ('忠县人民法院', 3), ('梁平区人民法院', 4), ('永川区人民法院', 70), ('江北区人民法院', 1806), ('江津区人民法院', 112), ('沙坪坝区人民法院', 1900), ('涪陵区人民法院', 51), ('渝中区人民法院', 484), ('渝北区人民法院', 1094), ('潼南区人民法院', 5), ('璧山区人民法院', 21), ('石柱土家族自治县人民法院', 7), ('秀山土家族苗族自治县人民法院', 2), ('第一中级人民法院', 40), ('第三中级人民法院', 3), ('第二中级人民法院', 15), ('第五中级人民法院', 156), ('第四中级人民法院', 6), ('綦江区人民法院', 42), ('荣昌区人民法院', 7), ('酉阳土家族苗族自治县人民法院', 2), ('重庆铁路运输法院', 3), ('铜梁区人民法院', 14), ('长寿区人民法院', 1), ('高级人民法院', 42), ('黔江区人民法院', 33)]
...
PLAAGE = {'20岁以下': 0, '20~30岁': 1303, '31~40岁': 4217, '41~50岁': 928, '51~60岁': 156, '61~70岁': 344, '70岁以上': 66}
PLAAGE_FEMALE = {'20岁以下': 0, '20~30岁': 162, '31~40岁': 148, '41~50岁': 39, '51~60岁': 25, '61~70岁': 111, '70岁以上': 8}
PLAAGE_MALE = {'20岁以下': 0, '20~30岁': 1141, '31~40岁': 4068, '41~50岁': 887, '51~60岁': 131, '61~70岁': 233, '70岁以上': 58}
DEFAGE = {'20岁以下': 0, '20~30岁': 39, '31~40岁': 173, '41~50岁': 45, '51~60岁': 42, '61~70岁': 10, '70岁以上': 5}
DEFAGE_MALE = {'20岁以下': 0, '20~30岁': 33, '31~40岁': 152, '41~50岁': 37, '51~60岁': 39, '61~70岁': 8, '70岁以上': 5}
DEFAGE_FEMALE = {'20岁以下': 0, '20~30岁': 6, '31~40岁': 21, '41~50岁': 8, '51~60岁': 3, '61~70岁': 2, '70岁以上': 0}
plaintiff_sex = {'男': 6922, '女': 521}
defendant_sex = {'男': 291, '女': 42}
aj_male = [plaintiff_sex['男'],defendant_sex['男']]
aj_female = [plaintiff_sex['女'],defendant_sex['女']]
case_date_number = {'2017': 2307, '2018': 2459, '2019': 2754}
...
class OverviewInfo:
    ...
    def get_overview_data(self):
        ...
        jdjf_ajnumber = 8439#LHJF.objects.count()  #
...
class ChartData:
    ...
    def get_person_info(self):
        ...
        pie_edu_data = {
            'name': '当事人学历',
            'data': [{'name': '未知', 'y': 256}, {'name': '文盲', 'y': 3}, {'name': '小学文化', 'y': 48}, {'name': '中学文化', 'y': 59}, {'name': '高中文化', 'y': 8}, {'name': '大专文化', 'y': 0}, {'name': '本科文化', 'y': 0}, {'name': '研究生文化', 'y': 0}]
        }
        his_age_data = ChartData().get_his_age_data()
        his_job_data = [['无业游民', '工人', '自营业主', '教师', '医生', '农民'], [23, 11, 0, 0, 0, 61]]
