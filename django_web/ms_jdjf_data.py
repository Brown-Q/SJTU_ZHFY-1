...
class MsJdjfData:
    ...
    def get_court_info(self):
        ...
        court1 = [('万州区人民法院', 1060), ('丰都县人民法院', 439), ('九龙坡区人民法院', 1708), ('云阳县人民法院', 604), ('八归档的九龙坡区人民法院', 1), ('北碚区人民法院', 619), ('南岸区人民法院', 1645), ('南川区人民法院', 441), ('合川区人民法院', 1145), ('垫江县人民法院', 743), ('城口县人民法院', 208), ('大渡口区人民法院', 224), ('大足区人民法院', 638), ('奉节县人民法院', 1180), ('巫山县人民法院', 569), ('巫溪县人民法院', 543), ('巴南区人民法院', 1015), ('庆市大渡口区人民法院', 1), ('开县人民法院', 27), ('开州区人民法院', 700), ('彭水苗族土家族自治县人民法院', 428), ('彭水苗族土彭水苗族土家族自治县人民法院', 1), ('忠县人民法院', 401), ('梁平区人民法院', 430), ('梁平县人民法院', 2), ('武隆区人民法院', 194), ('武隆县人民法院', 3), ('永川区人民法院', 665), ('江北区人民法院', 1604), ('江津区人民法院', 1386), ('沙坪坝区人民法院', 1455), ('涪陵区人民法院', 1275), ('渝中区人民法院', 1041), ('渝北区人民法院', 2493), ('潼南区人民法院', 375), ('潼南县人民法院', 1), ('璧山区人民法院', 779), ('石柱土家族自治县人民法院', 247), ('秀山土家族苗族自治县人民法院', 282), ('第一中级人民法院', 748), ('第三中级人民法院', 275), ('第丰都县人民法院', 1), ('第二中级人民法院', 513), ('第五中级人民法院', 789), ('第四中级人民法院', 80), ('綦江区人民法院', 473), ('荣昌区人民法院', 596), ('荣昌县人民法院', 1), ('酉阳土家族苗族自治县人民法院', 145), ('重庆万州区人民法院', 1), ('重庆大渡口区人民法院', 1), ('重庆巫溪县人民法院', 1), ('铜梁区人民法院', 285), ('长寿区人民法院', 862), ('高级人民法院', 303), ('黔江区人民法院', 360)]
        court = {}
        for i in court1:
            m = i[0].replace('区','')
            m = m.replace('人民法院', '')
...
PLAAGE = {'20岁以下': 7, '20~30岁': 1831, '31~40岁': 5602, '41~50岁': 10125, '51~60岁': 6870, '61~70岁': 2875, '70岁以上': 825}
PLAAGE_FEMALE = {'20岁以下': 2, '20~30岁': 650, '31~40岁': 2069, '41~50岁': 3453, '51~60岁': 2429, '61~70岁': 933, '70岁以上': 220}
PLAAGE_MALE = {'20岁以下': 5, '20~30岁': 1179, '31~40岁': 3524, '41~50岁': 6663, '51~60岁': 4436, '61~70岁': 1941, '70岁以上': 604}
DEFAGE = {'20岁以下': 5, '20~30岁': 2457, '31~40岁': 7196, '41~50岁': 10080, '51~60岁': 7189, '61~70岁': 1583, '70岁以上': 239}
DEFAGE_MALE = {'20岁以下': 4, '20~30岁': 1877, '31~40岁': 5572, '41~50岁': 7972, '51~60岁': 5518, '61~70岁': 1120, '70岁以上': 174}
DEFAGE_FEMALE = {'20岁以下': 1, '20~30岁': 567, '31~40岁': 1617, '41~50岁': 2098, '51~60岁': 1649, '61~70岁': 459, '70岁以上': 65}
plaintiff_sex = {'男': 18639, '女': 9895}
defendant_sex = {'男': 22685, '女': 6595}
aj_male = [plaintiff_sex['男'],defendant_sex['男']]
aj_female = [plaintiff_sex['女'],defendant_sex['女']]
case_date_number = {'2017': 11952, '2018': 19221, '2019': 23076}
...
class OverviewInfo:
    ...
    def get_overview_data(self):
        ...
        jdjf_ajnumber = 52007#LHJF.objects.count()  #
...
class ChartData:
    ...
    def get_person_info(self):
        ...
        his_job_data = [['无业游民', '工人', '自营业主', '教师', '医生', '农民'], [8, 6, 0, 20, 1, 410]]
